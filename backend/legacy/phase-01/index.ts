...
function printHelp(): void {
  console.log("Usage:");
  console.log("  npm run dev -- src/phase-01/index.ts add <title>");
  console.log("  npm run dev -- src/phase-01/index.ts list");
  console.log("  npm run dev -- src/phase-01/index.ts done <id>");
  console.log("  npm run dev -- src/phase-01/index.ts remove <id>");
  console.log("  npm run dev -- src/phase-01/index.ts clear");
}
